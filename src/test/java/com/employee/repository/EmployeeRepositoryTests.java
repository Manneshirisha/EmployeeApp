...
public class EmployeeRepositoryTests 
{
	...
	public void setup()
	{
		 obj=EmployeeEntity.builder().employeeName("vyshu")
				.employeeContact("9948866318")
				.employeeAge(21)
				.employeeSalary("30000")
				.employeeDOB("13/11/2000")
				.build();
	}
	...
	{
		//Given
//		EmployeeEntity obj=EmployeeEntity.builder().employeeName(                  "vyshu")
//													.employeeContact("9948866318")
//													.employeeAge(21)
//													.employeeSalary("30000")
//													.employeeDOB("13/11/2000")
...
//				.build();
		...
		EmployeeEntity obj1=EmployeeEntity.builder().employeeName("chinnu")
				.employeeContact("9948866318")
				.employeeAge(21)
				.employeeSalary("30000")
				.employeeDOB("13/11/2000")
